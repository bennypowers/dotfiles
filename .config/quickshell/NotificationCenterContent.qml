    ...
    ColumnLayout {
        ...
        ScrollView {
            ...
            Layout.preferredHeight: {
                var listHeight = 0;
                if (notificationServer && notificationServer.trackedNotifications.values.length > 0) {
                    // Approximate height per notification item
                    listHeight = notificationServer.trackedNotifications.values.length * 100;
                } else {
                    listHeight = 200; // Empty state height
                }
                return Math.min(600, listHeight);
            }
            clip: true
                            ...
                            Flow {
                                ...
                                Repeater {
                                    ...
                                    Button {
                                        ...
                                        onClicked: {
                                            modelData.invoke();
                                            notificationCenterContent.modelData.dismiss();
                                        }
                                    }
                                }
                            }
