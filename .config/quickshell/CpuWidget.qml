    ...
    Column {
        ...
        Item {
            ...
            Rectangle {
                ...
                Behavior on color {
                    ColorAnimation {
                        duration: cpuWidget.colorAnimationDuration
                    }
                }
            }
            ...
            Canvas {
                ...
                onPaint: {
                    ...
                    if (cpuWidget.cpuUsage >= 75)
                        activeBand = 3;
                    else if (cpuWidget.cpuUsage >= 50)
                        activeBand = 2;
                    else if (cpuWidget.cpuUsage >= 25)
                        activeBand = 1;
                    else
                        activeBand = 0;
                    ...
                    if (component.status === Component.Ready) {
                        ...
                        if (tooltipContent) {
                            ...
                            tooltipContent.cpuUsage = Qt.binding(function () {
                                return cpuWidget.cpuUsage;
                            });
                            tooltipContent.coreUsages = Qt.binding(function () {
                                return cpuWidget.coreUsages;
                            });
